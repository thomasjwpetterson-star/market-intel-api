...
government or first-party sources may be used to clarify a material supplier role.
...
CAGE, city/state, evidence status, matching NIIN count, example items, associated platforms and the
