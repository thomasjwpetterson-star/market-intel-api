...
PLATFORM_ALIASES = {
    ...
    "AVENGER AIR DEFENSE": "AVENGER (FAADS LOS-R)",
    "AN TWQ 1 AVENGER": "AVENGER (FAADS LOS-R)",
    "CLOSE IN WEAPON SYSTEM": "MK15 CLOSE IN WPN SYS",
    "CIWS": "MK15 CLOSE IN WPN SYS",
    "CONVENTIONAL PROMPT STRIKE": "INTERMEDIATE RANGE CONVENTIONAL PROMPT STRIKE (IRCPS)",
    "CPS": "INTERMEDIATE RANGE CONVENTIONAL PROMPT STRIKE (IRCPS)",
    "HYPERSONIC ATTACK CRUISE MISSILE": "HACM",
    "INDIRECT FIRE PROTECTION CAPABILITY": "IFPC INC 2",
    "IFPC": "IFPC INC 2",
    "AIM 260": "AIM-260 JATM",
    "JATM": "AIM-260 JATM",
    "LONG RANGE STAND OFF WEAPON": "LRSO",
    "GBU 39": "GBU-39 SMALL DIAMETER BOMB",
